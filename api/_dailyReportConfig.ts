/**
 * SolarOps, end-of-day report config shape, serverless copy.
 *
 * DUPLICATED from solarflow-dashboard/src/lib/dailyReportConfig.ts for the same
 * reason as _activityStats.ts: api/ must not import from the app source.
 * dailyReportParity.test.ts pins the two to identical behaviour.
 */
