...
function App() {
  ...
  const renderView = () => {
    // Sales reps can only access crm and customers. (Lead Lobby was removed;
    ...
    //
    // 2026-09-07: sales moved from the old 'customers2' screen to the real
    // Customers screen. The old one rendered an unsynced localStorage store, so
    // anything sales filed there, attachments included, was invisible to the
    // rest of the company and to sales themselves on any other device.
    if (currentUser?.role === 'sales' && !['crm', 'customers'].includes(currentView)) {
