    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-1.5">
          ...
          {lead.isPowercare && (
            <span title="Powercare" className="text-xs bg-amber-100 text-amber-700 px-1 py-0.5 rounded-full flex-shrink-0 inline-flex items-center"><Zap className="w-3 h-3" /></span>
          )}
        </div>
