...
const defaultServiceRates: ServiceRate[] = [
  ...
  },
  {
    ...
    description: 'Optimizer or microinverter replacement, base rate covers up to 4 units, additional units billed per unit. Serial # + voltage test photo required per unit.',
    estimatedHours: 3,
    laborCost: 120,
    partsCost: 0,
  ...
  },
  {
    ...
    description: 'Complete battery replacement including disposal and return. PowerCare eligible.',
    estimatedHours: 4,
    laborCost: 500,
    partsCost: 0,
  ...
  },
  {
    ...
    description: 'Battery replacement for clients not under PowerCare. Includes disposal and return.',
    estimatedHours: 4,
    laborCost: 500,
    partsCost: 0,
  ...
  },
  {
    ...
    description: 'SolarEdge site ownership transfer, handled by admin team via agentic workflow. Requires Inverter Serial Number and/or Site ID. Flat client charge, no field cost.',
    estimatedHours: 0,
    laborCost: 0,
    partsCost: 0,
    clientRateStandard: 120,
    clientRateRecurring: 120,
    isPowercareEligible: false,
    powercareLaborCost: 0,
    powercareClientRate: 0,
    seCompensation: 0,
    bypassQuoteApproval: true,
    adminTeamOnly: true,
    active: true
  },
];
