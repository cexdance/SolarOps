...
// Multi-state service pipeline, mirrors the "Conexsol Florida Services" Trello
// board that TX/GA now run on. Deliberately ORTHOGONAL to status/woStatus: this
// tracks the sales + site-transfer funnel, those track execution. Nothing in
// billing or contractor visibility reads this field.
// ponytail: plain string union, no per-stage config object until a stage needs
// more than a label and a color.
export const PIPELINE_STAGES = [
  'leads',
  'needs_first_quote',
  'first_quote_in_progress',
  'site_transfer_processing',
...
export const PIPELINE_STAGE_LABEL: Record<PipelineStage, string> = {
  ...
  site_transfer_processing:  'Site Transfer is Processing',
