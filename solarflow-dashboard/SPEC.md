...
> Duplicate legacy specification, retained for reference. Current rules and feature scope follow dated corrections. Tailwind 3.4.16 and scoped CSS are current; the original all-financials/Xero assumptions are superseded. See [[Audit Preparation 2026-09-07/00 Current documentation guidance]].
